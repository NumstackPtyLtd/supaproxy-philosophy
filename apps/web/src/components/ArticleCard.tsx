...
export function ArticleCard({ article, onClick }: ArticleCardProps) {
  return (
    <button
      onClick={onClick}
      className="text-left rounded-2xl overflow-hidden card-hover w-full cursor-pointer"
      style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)' }}
    >
      {/* Color bar */}
      <div className="h-1.5" style={{ background: article.coverColor }} />
      ...
      <div className="p-6">
        ...
        {/* Subtitle */}
        <p className="text-[14px] leading-relaxed mb-4" style={{ color: 'var(--body)' }}>
          {article.subtitle}
        </p>

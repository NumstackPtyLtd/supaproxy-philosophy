...
export const article: Article = {
  ...
  blocks: [
    ...
    { type: 'heading', text: 'Depend on abstractions, not implementations' },
    ...
    { type: 'paragraph', text: 'The change we are making is that the container accepts auth from outside.' },

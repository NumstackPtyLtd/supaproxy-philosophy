...
export const article: Article = {
  ...
  blocks: [
    ...
    { type: 'paragraph', text: 'The practical path forward is a layered system. At the base layer, structural format preservation: a name becomes a name, a number becomes a number. This is table stakes and should work out of the box. Above that, semantic preservation rules that organisations configure per entity type and per domain. These are the rules that say "preserve the age bracket in SA IDs" or "derive the email from the avatar name." At the top, cross-entity consistency that ensures the fictional identity holds together under cross-reference.' },
